#!/usr/bin/env python3
"""
FMCW Radar Waterfall Demo - Mac Edition
...
Based on Jon Kraft's FMCW Radar Demo, adapted for Aleph hybrid architecture.
"""
...
print("=" * 60)
print("FMCW Radar Waterfall - Mac Edition")
print("=" * 60)
...
class Window(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("FMCW Radar Waterfall - Aleph/Mac")
    ...
    def UiComponents(self):
        ...
        # Control Panel
        control_label = QLabel("PHASER FMCW Radar (Aleph/Mac)")
...
def update():
    ...
    global index, plot_dist, freq, dist, rx_error_count
    label_style = {"color": "#FFF", "font-size": "14pt"}
