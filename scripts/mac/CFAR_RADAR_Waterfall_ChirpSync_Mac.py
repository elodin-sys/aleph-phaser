#!/usr/bin/env python3
"""
CFAR Radar Waterfall with ChirpSync Demo - Mac Edition

Uses the Pluto TDD engine for synchronized chirp FFT data collection with
...
Based on Jon Kraft's CFAR ChirpSync Demo.
"""
...
print("=" * 60)
print("CFAR Radar Waterfall (ChirpSync) - Mac Edition")
print("=" * 60)
...
class Window(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CFAR Radar ChirpSync - Aleph/Mac")
    ...
    def UiComponents(self):
        ...
        # Control Panel
        control_label = QLabel("PHASER CFAR ChirpSync (Aleph/Mac)")
